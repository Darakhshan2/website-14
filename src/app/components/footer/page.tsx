    ...
    <div>
        <div className='bg-black  text-white divide-y divide-gray-600'>
            ...
            <div className='flex items-center space-x-2 justify-center py-3 text-gray-600'>
                ...
                <div className='flex text-4xl ml-2 align-middle'>
          <a href="https://github.com/Darakhshan2 " target='blank'>
        <LuGithub  className='border-2 p-1 hover:border-red-600  rounded-full' />
        </a>
        <a href='https://www.linkedin.com/in/darakhshan-junaid-5713b422b/'>
        <FaLinkedinIn  className='border-2 ml-3 p-1 hover:border-red-600 rounded-full'/>
        </a>
        <a href='mailto:darakhshanjunaid2@gmail.com'>
        <MdOutlineMarkEmailRead  className='border-2 ml-3 p-1 hover:border-red-600 rounded-full hover:text' />
        </a>
        </div>
            </div>
        </div>
